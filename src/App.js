          ...
          <div className="login-area">
            <form>
              ...
              <div className="forgot" style={{ textAlign: "center" }}>
                <a href="##" onClick={handleShow} className="forgot"><i className="fa fa-key forgot2"> &nbsp;</i>Şifremi Unuttum</a>
              </div>
                ...
                <form>
                  <Modal.Body>
                    ...
                    <div className="input-group">
                      ...
                      <input type="text" minLength="11" maxLength="11" id="tc" className="form-control" placeholder="T.C. Kimlik Numarası" aria-describedby="basic-addon1" required />
                    </div>
                  </Modal.Body>
                  <Modal.Footer>

                    <button type="submit" className="button w-100"><i className="fa fa-paper-plane"></i>&nbsp;Gönder</button>
