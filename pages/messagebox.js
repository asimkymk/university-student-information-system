                ...
                <div className={`container ${styles.mainContainer}`} >
                    <div style={{ paddingTop: ".5rem", paddingBottom: ".5rem" }}>
                        <div className={`row ${styles.lecturer}`} >
                            <div className={`my-auto`} style={{ marginLeft: "1rem", width: "5rem", padding: "0" }} >
                                <Image
                            ...
                            <div className={`col my-auto`}>
                                ...
                                <div className={`row ${styles.innerTextLecturer}`}>
                                    Evet, projede istediğiniz frameworkü kullanabilirsiniz. Proje son teslim tarihi 14.05.2022&apos;dir. Geç teslim kabul edilmeyecektir.
                                </div>
                            </div>
                            <div className={`col-3 my-auto ${styles.innerReplyLecturer}`}>
                                <button type="button" className="btn uploadButton " title="Mesaj Gönder" value="Mesaj Gönder">
