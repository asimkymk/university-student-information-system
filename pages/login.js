          ...
          >
            ...
            <div className={loginStyles.loginArea}>
              <form>
                ...
                <Modal show={show} onHide={handleClose} centered className={`mx-auto my-auto`}>
                ...
                <Modal show={show2} onHide={handleClose2} centered>
                  ...
                  <form>
                    <Modal.Body>
                      <div className={`${loginStyles.label}`}>T.C. Kimlik Numarası</div>
                      <div
                      ...
                      <div className={`${loginStyles.label}`}>E-Posta Adresi</div>
                      <div
                        className={`input-group mb-2 ${loginStyles.inputGroup}`}
                      >
                        <div
                      ...
                      <div style={{ width: "49%", float: "left" }}>
                        <div className={`${loginStyles.label}`}>Doğum Tarihi</div>
                        <div
                          className={`input-group mb-2 ${loginStyles.inputGroup}`}
                        >
                          <div
